...
/* Release 4.0.3                                                              */
/******************************************************************************/
#ifndef LIN_SLAVE_70_HW_H
#define LIN_SLAVE_70_HW_H
...
/*---------------- no file version information ----------------*/

/*----------------------------------------------------------------------------*/
/* file version information                                   */
/*----------------------------------------------------------------------------*/
#define LIN_SLAVE_70_VENDOR_ID_HW_H                ( 70U )
#define LIN_SLAVE_70_MODULE_ID_HW_H                ( 82U )

#define LIN_SLAVE_70_AR_RELEASE_MAJOR_VERSION_HW_H ( 22U )
#define LIN_SLAVE_70_AR_RELEASE_MINOR_VERSION_HW_H ( 11U )
#define LIN_SLAVE_70_AR_RELEASE_REVISION_VERSION_HW_H ( 00U )

#define LIN_SLAVE_70_SW_MAJOR_VERSION_HW_H         ( 1U )
#define LIN_SLAVE_70_SW_MINOR_VERSION_HW_H         ( 0U )
#define LIN_SLAVE_70_SW_PATCH_VERSION_HW_H         ( 0U )
...
/* macros                                                     */
/*----------------------------------------------------------------------------*/
#define Lin_70_HW_MstInit( chIndex, baudRatePrescaler )         Lin_70_RL78F2X_Init( ( chIndex ), ( baudRatePrescaler ) )
...
#endif  /* #ifndef LIN_SLAVE_70_HW_H */
/* End Of File */
