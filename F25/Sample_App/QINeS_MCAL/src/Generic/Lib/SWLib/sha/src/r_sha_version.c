...
/* Macro definitions                                                          */
/*----------------------------------------------------------------------------*/
#define __COMPILER_VER_UNDEFINED__  (0xFFFFFFFF)
...
const mw_version_t R_sha_version =
{
    __COMPILER_VER__,
    "SHA Hash Function Library version "__R_SHA_VERSION__" for "__TARGET_CPU__"" "\n"
};
